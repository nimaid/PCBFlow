...
InputFileName       = "output.sp"
PCBTemplateFile     = "../30_PLACE/board_template.brd" 
PCBOutputFile       = "final.brd"
SpiceOutputFile     = "final.sp"
FanoutOutputFile    = "final_fanout.txt"
NetsOutputFile      = "final_nets.csv"
PlacementOutputFile = "final_placement.csv"
...
pltdata = pdframe.pivot(columns=('Y','X','Celltype'))
print(pltdata)
print()
...
pltdata = pdframe.pivot(columns=('Y','X','Nets'))
# print(pltdata)
